...
public class GameApplet extends JFrame implements ActionListener, Runnable
{
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(new Runnable() {
         @Override
         public void run() {
            new GameApplet(); // Let the constructor do the job
         }
      });
   }
 ...
 /**
   ...
   public void actionPerformed(ActionEvent e)
   {
	...
	private void readDictionary()
	{
		...
		try
		{
			URL url = new URL("file:///home/lee/Courses/s16/15650/hw2/HW2-Boggle/code/BoggleDictionary.txt");
			InputStream inStream = url.openConnection().getInputStream();

			in = new Scanner(inStream);
			
			while (in.hasNext()) {
				dictionary.add(in.next().toUpperCase());
			}
		}
